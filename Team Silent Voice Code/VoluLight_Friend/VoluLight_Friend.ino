...
//other
enum debug {sp = true, dly = true, /*dl = 200,*/ vt = false}; //sp - serial print, dly - delay, dl - delay length, vt - variable testing
...
Serial.println(analogRead(A0));
  ...
  checkToggle();
  SwitchLights(PickLight(analogRead(A0), ala.current));
